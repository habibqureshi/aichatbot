...
TWILIO_FORWARDING_NUMBER = os.getenv("TWILIO_FORWARDING_NUMBER", "")
# JWT / Auth
...
LANGFUSE_SECRET_KEY = os.getenv(
    "LANGFUSE_SECRET_KEY", "sk-lf-7c9b1181-280c-43ae-8f8c-ad44e1dc5f6d"
)
LANGFUSE_PUBLIC_KEY = os.getenv(
    "LANGFUSE_PUBLIC_KEY", "pk-lf-40384b65-3977-4e37-b0b0-06fa59fa9ff7"
)
