        ...
        <form onSubmit={onSubmit} className="space-y-4 sm:space-y-6">
          ...
          <div className="flex justify-end">
            <button
              ...
              className="px-6 py-2 bg-gradient-to-r from-[#9882F7] to-[#4318FF] text-white rounded-md hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
            >
